...
<script type="text/javascript">
	...
	function zipSearch() {
		...
		window.open(url,"우편번호검색","width=500, height=350, scrollbars=yes");
		
	}
</script>
</head>
<body bgcolor="#FFFFCC" onLoad="regFrm.id.focus()"> <!--실행과 동시에 커서를 아이디에-->	
         <div align="center">
		<br /><br />
						...
						<table border="1" cellspacing="0" cellpadding="2" width="600">
							...
							<tr>
								...
								<td width="50%">
									...
									<input type="button" value="ID중복확인" onClick="idCheck(this.form.id.value)"> <!-- 매우중요 -->
								</td>
